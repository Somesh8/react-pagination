...
function Table({ columns, data, updatePageSize, updatePageNumber, currentPageData }) {
                        ...
                        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div className="flex gap-x-2">
                                <span className="text-sm text-gray-700">
                                    Page <span className="font-medium">{currentPageData.currentPage}</span> of{" "}
                                    <span className="font-medium">{ Math.ceil(currentPageData.totalData / currentPageData.pageSize) }</span>
                                </span>
                                <label>
                            ...
                            <div>
                                ...
                                >
                                    <PageButton
                                        ...
                                        onClick={() => updatePageNumber("first")}
                                    ...
                                    <PageButton
                                        onClick={() => updatePageNumber("previous")}
                                        // disabled={!canPreviousPage}
                                    >
