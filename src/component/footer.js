...
const links = [
  ...
  { name: 'Help', description: 'Understand how we take your privacy seriously.', href: '#', icon: ShieldCheckIcon },
]
const contacts = [
  { id: 1, name: 'New York, NY 10012, US', href: '#', icon: HomeIcon },
  { id: 2, name: 'info@example.com', href: '#', icon: InboxIcon },
  { id: 3, name: '+ 01 234 567 88', href: '#', icon: PhoneIcon },
  { id: 4, name: '+ 01 234 567 89', href: '#', icon: MicrophoneIcon },
]
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="">
            ...
            {products.map(item => (
              <p className="mb-4">
                <a href="#!" className="text-gray-600">{item.name}</a>
              </p>
            ))}
          </div>
          <div className="">
